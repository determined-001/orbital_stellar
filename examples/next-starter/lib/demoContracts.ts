...
import { isPingEvent } from "./generated/demoEmitter";
import { isTransferEvent, isMintEvent, isBurnEvent } from "./generated/usdc";
 ...
 * `EventEngine` means only the demo-emitter's events actually arrive by
 * default - USDC's guards below still run for real against every
