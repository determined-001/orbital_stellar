...
import type { Tracer, VerifyWebhookOptions, WebhookConfig, RetryRecord, RetryQueue, WebhookMetrics } from "./types.js";
...
type ResolvedWebhookConfig = Omit<Required<WebhookConfig>, "url" | "tracer" | "urlValidator" | "retryQueue" | "deadLetterStore" | "metrics"> & {
  urls: string[];
  tracer?: Tracer;
  ...
  private async deliverToUrl(
    ...
    try {
      ...
      if (attempt < this.config.retries) {
        ...
        this.dlq.add(url, event, errorMessage, attempt);
