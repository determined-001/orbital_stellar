...
- [Migrate from raw EventSource](../../apps/web/content/guides/migrate-from-eventsource.md) — before/after for manual `useEffect` subscriptions, client-side type filtering, and duplicate connections per address
