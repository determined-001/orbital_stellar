 ...
 * through a locked-down renderer rather than marked's defaults: raw HTML is escaped instead of
 * passed through, and link/image URLs are scheme-checked, so a stray HTML snippet or odd URL in
 * a TSDoc comment can't end up as live markup in the page.
 *
