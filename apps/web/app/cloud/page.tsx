  ...
  return (
    <section style={{ padding: "120px 32px" }}>
      <div style={{ maxWidth: "760px", margin: "0 auto" }}>
        ...
        >
          You most likely arrived here from a demo limit. Hosted Orbital is not running yet — there
          is nothing to sign up for, and we would rather say so than collect an email against a
        ...
        >
          ...
          >
            ...
            cooldown, and no session timeout — you are talking to Horizon and Soroban RPC directly.
          </p>
          <pre
            style={{
              fontFamily: "var(--font-mono)",
